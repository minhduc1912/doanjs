...
import CagtegoryFreshProductDisplay from '../components/CategoryFreshProductDisplay';
...
const ProductDetails = () => {
  ...
  return (
    <div className='container mx-auto p-4'>
      ...
      {
        data.category && (
          <CagtegoryFreshProductDisplay category={data?.category} heading={"Recommended Product"}/>
        )
      }
