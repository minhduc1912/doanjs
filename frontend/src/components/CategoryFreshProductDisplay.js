...
import fetchCategoryFreshProduct from '../helpers/fetchCategoryFreshProduct'
import displayVNDCurrency from '../helpers/displayCurrency'

const CagtegoryFreshProductDisplay = ({category, heading}) => {
    ...
    const fetchData = async() =>{
        setLoading(true)
        const categoryProduct = await fetchCategoryFreshProduct(category)
        setLoading(false)
...
export default CagtegoryFreshProductDisplay